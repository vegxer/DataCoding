...
namespace HuffmanCoderTest
{
    ...
    public class HuffmanCoderTest
    {
        ...
        public void TestMethodFIO()
        {
            ...
            HuffmanEncoder encoder = new HuffmanEncoder("text.txt", "encoded.txt");
            encoder.Encode();
            HuffmanDecoder decoder = new HuffmanDecoder("encoded.txt", "decoded.txt");
            decoder.Decode();
